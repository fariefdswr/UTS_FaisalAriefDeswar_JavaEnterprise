...
public class CategoryService{
    ...
    public Category updateCategory(Category category, Integer id) {
        ...
        if(updateCategory != null) {
            updateCategory.setKd_Bahan(category.getKd_Bahan());
            updateCategory.setNama_Bahan(category.getNama_Bahan());
            updateCategory.setJenis_Bahan(category.getJenis_Bahan());
        }
